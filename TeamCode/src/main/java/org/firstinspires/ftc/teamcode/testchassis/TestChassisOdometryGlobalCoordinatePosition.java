...
import static org.firstinspires.ftc.teamcode.testchassis.TestChassisOpMode.ODOMETER_COUNTS_PER_INCH;

public class TestChassisOdometryGlobalCoordinatePosition implements Runnable {
    ...
    //Algorithm constants
    private static double robotEncoderWheelDistance;
    private static double horizontalEncoderTickPerDegreeOffset;
     ...
     */
    public TestChassisOdometryGlobalCoordinatePosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, int threadSleepDelay, BNO055IMU imu) {
        ...
        robotEncoderWheelDistance = Double.parseDouble(ReadWriteFile.readFile(wheelBaseSeparationFile).trim()) * ODOMETER_COUNTS_PER_INCH;
