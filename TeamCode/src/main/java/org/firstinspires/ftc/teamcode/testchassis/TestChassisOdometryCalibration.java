 ...
 */
@Autonomous(name = "Odometry System Calibration TestChassis", group = "Calibration")
@Config
public class TestChassisOdometryCalibration extends LinearOpMode {
    //Drive motors
    ...
    private String rfName = "rightFront", rbName = "rightRear", lfName = "leftFront", lbName = "leftRear";
    private String verticalLeftEncoderName = rfName, verticalRightEncoderName = lbName, horizontalEncoderName = rbName;
